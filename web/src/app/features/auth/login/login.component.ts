...
@Component({
  ...
  template: `
    <div class="auth-page">
      <!-- Container: Kayıt modundaysa .right-panel-active sınıfını alır -->
      <div class="container" [class.right-panel-active]="isRegisterMode">
        
        <!-- SIGN UP FORM (Kayıt Ol) -->
        ...
        <div class="form-container sign-in-container">
          <form [formGroup]="loginForm" (ngSubmit)="onLoginSubmit()">
            ...
            <a href="#" class="forgot-password">{{ 'AUTH.FORGOT_PASSWORD' | translate }}</a>
        ...
        <!-- OVERLAY PANEL (Glassmorphism Kayan Panel) -->
        <div class="overlay-container">
          <div class="overlay">
            
            <!-- Sol Overlay (Kayıt ol formunun üzerindeyken görünür - Giriş'e yönlendirir) -->
            ...
            <!-- Sağ Overlay (Giriş formunun üzerindeyken görünür - Kayıt'a yönlendirir) -->
...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (isPlatformBrowser(this.platformId)) {
      this.isRegisterMode = window.location.pathname.includes('register');
    }
  }
